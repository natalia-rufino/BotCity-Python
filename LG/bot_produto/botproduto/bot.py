...
def acessar_site(bot):
    ...
    bot.print_pdf(r'C:\Users\noturno\Desktop\BotCity-Python\LG\bot_produto\botproduto\pdf\SiteProduto.pdf')
...
def main():
    ...
    arq_excel = r'C:\Users\noturno\Desktop\BotCity-Python\LG\bot_produto\botproduto\planilha\RelacaoProduto.xlsx'
    sheet = 'produto'  
    ...
    lista_pdf = []
    lista_pdf.append(r'C:\Users\noturno\Desktop\BotCity-Python\LG\bot_produto\botproduto\pdf\ListaProduto.pdf')
    lista_pdf.append(r'C:\Users\noturno\Desktop\BotCity-Python\LG\bot_produto\botproduto\pdf\SiteProduto.pdf')
    ...
    arq_anexo = r'C:\Users\noturno\Desktop\BotCity-Python\LG\bot_produto\botproduto\pdf\Produtos.pdf'
    retornoJSON_usuarios = api_lista_usuarios()
    lista_produto = retornoJSON_usuarios['dados']
    for usuario in lista_produto:
        destinatario = usuario['natalia.rufino@ifam.edu.br']
